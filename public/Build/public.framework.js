...
var ASM_CONSTS = {
  3512460: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3512515: function($0) {performance.now = function() { return $0; };},  
 3512563: function($0) {performance.now = function() { return $0; };},  
 3512611: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3512666: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3512727: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3512791: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _OpenTuBoleto() {
      //console.log("opening tuboleto link");
      document.location = "turuta://showinterstitial";
    }
